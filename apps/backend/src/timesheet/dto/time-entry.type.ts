...
export class TimeEntryType {
  ...
  @Field(() => ID, {
    description: 'ID of the consultant who created this entry',
  })
  consultantId: string;

  @Field(() => ID, {
    description: 'ID of the pay period this entry belongs to',
  })
  payPeriodId: string;
  ...
  @Field(() => Date, {
    nullable: true,
    description: 'First clock-in time (ISO 8601 format)',
  })
  inTime1?: Date;

  @Field(() => Date, {
    nullable: true,
    description: 'First clock-out time (ISO 8601 format)',
  })
  outTime1?: Date;

  @Field(() => Date, {
    nullable: true,
    description: 'Second clock-in time (ISO 8601 format), for split shifts',
  })
  inTime2?: Date;

  @Field(() => Date, {
    nullable: true,
    description: 'Second clock-out time (ISO 8601 format), for split shifts',
  })
  outTime2?: Date;
  ...
  @Field(() => Boolean, {
    description: 'Whether this entry has been synced with the backend',
  })
  synced: boolean;
