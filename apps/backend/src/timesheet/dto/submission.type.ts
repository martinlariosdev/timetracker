...
export class TimesheetSubmissionType {
  ...
  @Field(() => ID, {
    description: 'ID of the consultant who submitted the timesheet',
  })
  consultantId: string;
  ...
  @Field(() => String, {
    description: 'Submission status: draft, submitted, approved, or rejected',
  })
  status: string;
  ...
  @Field(() => String, {
    nullable: true,
    description: 'ID of the team lead who approved the timesheet',
  })
  approvedBy?: string;

  @Field(() => Date, {
    nullable: true,
    description: 'Timestamp when the timesheet was rejected',
  })
  rejectedAt?: Date;

  @Field(() => String, {
    nullable: true,
    description: 'ID of the team lead who rejected the timesheet',
  })
  rejectedBy?: string;

  @Field(() => String, {
    nullable: true,
    description: 'Comments from team lead (especially for rejections)',
  })
  comments?: string;

  @Field(() => Date, {
    description: 'Timestamp when this submission was created',
  })
  createdAt: Date;
