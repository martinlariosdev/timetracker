...
import { ETOTransactionObjectType, UseETOInput, AdjustETOInput } from './dto';
...
export class ETOResolver {
   ...
   */
  @Query(() => Float, {
    description: 'Get current ETO balance for a consultant',
  })
  async etoBalance(
   ...
   */
  @Query(() => [ETOTransactionObjectType], {
    description: 'Get ETO transactions for a consultant',
  })
   ...
   */
  @Mutation(() => ETOTransactionObjectType, {
    description: 'Use ETO hours (take time off)',
  })
  async useETO(
   ...
   */
  @Mutation(() => ETOTransactionObjectType, {
    description: 'Manually adjust ETO balance (accrual or admin adjustment)',
  })
  async adjustETO(
