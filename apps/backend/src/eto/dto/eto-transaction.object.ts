 ...
 */
@ObjectType({
  description: 'ETO transaction record for tracking earned time off',
})
export class ETOTransactionObjectType {
  ...
  @Field(() => ID, {
    description: 'ID of the consultant who owns this transaction',
  })
  consultantId: string;
  ...
  @Field(() => ETOTransactionType, {
    description: 'Type of transaction: Accrual, Usage, or Adjustment',
  })
  ...
  @Field(() => String, {
    nullable: true,
    description: 'Project name associated with ETO usage',
  })
  projectName?: string | null;

  @Field(() => Boolean, {
    description: 'Whether this transaction has been synced with the backend',
  })
  synced: boolean;
